...
hl.animation({ leaf = "windows", enabled = true, speed = 1.1, spring = "easy" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 1.1, spring = "easy", style = "popin 87%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 1.19, bezier = "linear", style = "popin 87%" })
hl.animation({ leaf = "fadeIn", enabled = true, speed = 1.13, bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 1.16, bezier = "almostLinear" })
hl.animation({ leaf = "fade", enabled = true, speed = 1.03, bezier = "quick" })
hl.animation({ leaf = "layers", enabled = true, speed = 1.11, bezier = "easeOutQuint" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 1.19, bezier = "almostLinear" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 1.14, bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 1.11, bezier = "almostLinear", style = "fade" })
